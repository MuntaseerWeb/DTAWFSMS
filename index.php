                    ...
                    <div class="span9">
                    	<center>
                           	<div class="card" style="width: 50%;"> 
                    			...
                    			<div class="card-body">
                                <iframe video style="position:aling:center; height:300px;width:380px;top:90px;left:1150px" src="https://www.youtube.com/embed/Awzcv3YAWDE?mute=1&autoplay=1">
</iframe>

                                <?php
                                $phoneno = $_SESSION['PhoneNo'];
                                $sql="select * from LMS.user where PhoneNo='$phoneno'";
                                ...
                                ?>    
                    				...
                    				<br>
                    				<p><b>Guardian Mobile number: </b><?php echo $mobno ?></p>
                    				</b>
                                </i>
...
<div class="footer">
            ...
            <b class="copyright">&copy; 2021 Delta Team Shelter Management System </b>[All rights reserved.]
                ...
                <b>Delta Team Animal Welfare Foundation is one of the leading rescue team in Bangladesh.</b>
               <b> <p>Our Services:</p>
...
<ul>
    ...
    <li>Treatment</li>
    <li>Pet Transport</li>
    <li>Animal Sheltering</li>
    <li>Low Priced but 'A Grade' Medicines</li>
</ul></b>
<img src="images/011.jpg" alt="DP" style="width:1200px;height:500px;">
