        ...
        <div class="wrapper">
            <div class="container">
                <div class="row">
                    ...
                    <div class="span3">
                        <center>
                            <a href="issue_requests.php" class="btn btn-info" ><p>Issue Requests</p></a>
                        </center>
                    </div>
                    <div class="span3">
                        <center>
                            <a href="renew_requests.php" class="btn btn-info"><p>Renew Request</p></a>
                        </center>
                    </div> 
                    <div class="span3">
                        <center>
                            <a href="return_requests.php" class="btn btn-info"><p>Return Requests</p></a>
                        </center>
                    </div>
                    <!--/.span3-->
                    <!--/.span9-->
