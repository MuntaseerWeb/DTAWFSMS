                    ...
                    <div class="span9">
                        <div class="module">
                            ...
                            <div class="module-body">
                                ...
                                <form class="form-horizontal row-fluid" action="edit_user_details.php?id=<?php echo $phoneno ?>" method="post">
                                    ...
                                    <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <select name = "Category" tabindex="1" value="VISITOR" data-placeholder="Select Category" class="span6">
                                    ...
                                    <div class="control-group">
                                        <label class="control-label" for="MobNo"><b>Guardian Mobile Number:</b></label>
                                        <div class="controls">
...
$sql1="update LMS.user set Name='$name', Category='$category', EmailId='$email', MobNo='$mobno', Password='$pswd' where PhoneNo='$phoneno'";
