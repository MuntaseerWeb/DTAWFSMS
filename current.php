                    ...
                    <div class="span9">
                        <form class="form-horizontal row-fluid" action="current.php" method="post">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="title" name="title" placeholder="Enter phone No of user/animal Name/animal Id." class="span8" required>
                                    ...
                                    if(isset($_POST['submit']))
                                        {$s=$_POST['title'];
                                            $sql="select record.AnimalId,PhoneNo,Title,Due_Date,Date_of_Issue,datediff(curdate(),Due_Date) as x from LMS.record,LMS.animal where (Date_of_Issue is NOT NULL and Date_of_Return is NULL and animal.Animalid = record.AnimalId) and (PhoneNo='$s' or record.AnimalId='$s' or Title like '%$s%')";
                                        }
                                    else
                                        $sql="select record.AnimalId,PhoneNo,Title,Due_Date,Date_of_Issue,datediff(curdate(),Due_Date) as x from LMS.record,LMS.animal where Date_of_Issue is NOT NULL and Date_of_Return is NULL and animal.Animalid = record.AnimalId";
