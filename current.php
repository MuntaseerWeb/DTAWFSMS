                    ...
                    <div class="span9">
                        <form class="form-horizontal row-fluid" action="current.php" method="post">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="title" name="title" placeholder="Enter Animal Name/Animal Id." class="span8" required>
                                    ...
                                    if(isset($_POST['submit']))
                                        {$s=$_POST['title'];
                                            $sql="select * from LMS.record,LMS.animal where PhoneNo = '$phoneno' and Date_of_Issue is NOT NULL and Date_of_Return is NULL and animal.Animalid = record.AnimalId and (record.AnimalId='$s' or Title like '%$s%')";

                                        }
                                    else
                                        $sql="select * from LMS.record,LMS.animal where PhoneNo = '$phoneno' and Date_of_Issue is NOT NULL and Date_of_Return is NULL and animal.animalid = record.AnimalId";
                            ...
                            ?>
                                    ...
                                    <tr>
                                      ...
                                      <td><?php echo $duedate ?></td>
                                        ...
                                        <?php 
                                         if($renewals)
                                            echo "<a href=\"renew_request.php?id=".$animalid."\" class=\"btn btn-success\">Renew</a>";
                                        ?>
                                        <a href="return_request.php?id=<?php echo $animalid; ?>" class="btn btn-primary">Return</a>
                                        </center></td>
                                    </tr>
                            <?php }} ?>
                                    </tbody>
