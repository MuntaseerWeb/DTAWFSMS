            ...
            <div class="navbar-inner">
                <div class="container">
                    <a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
                        <i class="icon-reorder shaded"></i></a><a class="brand" href="index.php">Delta Team Shelter Management System </a>
                            ...
                            <div class="module-body">
                                    ...
                                    <form class="form-horizontal row-fluid" action="message.php" method="post">
                                        <div class="control-group">
                                            <label class="control-label" for="Phoneno"><b>Receiver Mobile No:</b></label>
                                            <div class="controls">
                                                <input type="text" id="PhoneNo" name="PhoneNo" placeholder="Phone Number" class="span8" required>
                                            </div>
                                        </div>
                                        <div class="control-group">
...
<div class="footer">
            <div class="container">
                <b class="copyright">&copy; 2021 Delta Team Animal Welfare Foundation (DTAWF). </b>All rights reserved.
...
$sql1="insert into LMS.message (PhoneNo,Msg,Date,Time) values ('$phoneno','$message',curdate(),curtime())";
