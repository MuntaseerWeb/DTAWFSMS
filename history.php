                    ...
                    <div class="span9">
                        <form class="form-horizontal row-fluid" action="history.php" method="post">
                                    ...
                                    if(isset($_POST['submit']))
                                        {$s=$_POST['title'];
                                            $sql="select * from LMS.record,LMS.animal where PhoneNo = '$phoneno' and Date_of_Issue is NOT NULL and Date_of_Return is NOT NULL and animal.Animalid = record.AnimalId and (record.AnimalId='$s' or Title like '%$s%')";

                                        }
                                    else
                                        $sql="select * from LMS.record,LMS.animal where PhoneNo = '$phoneno' and Date_of_Issue is NOT NULL and Date_of_Return is NOT NULL and animal.Animalid = record.AnimalId";
