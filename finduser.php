                        ...
                        <div class="content">
                            <div class="btn-controls">
                                <div class="btn-box-row row-fluid">
                                    <a href="findbook.php" class="btn-box big span4"><i class=" icon-search"></i><b>Find Animal</b>
                                    </a><a href="findbookissue.php" class="btn-box big span4"><i class="icon-book"></i><b>Find Animal That Issued</b>
