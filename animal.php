                    ...
                    <div class="span9">
                        <form class="form-horizontal row-fluid" action="animal.php" method="post">
                                    ...
                                    if(isset($_POST['submit']))
                                        ...
                                        $sql="select * from LMS.animal order by Availability DESC";
                        ...
                        <table class="table" id = "tables">
                            ...
                            ?>
                                    <tr>
                                      ...
                                      <td><center><a href="animaldetails.php?id=<?php echo $animalid; ?>" class="btn btn-primary">Details</a>
                                      	<?php
                                      	if($avail > 0)
                                      		echo "<a href=\"issue_request.php?id=".$animalid."\" class=\"btn btn-success\">Issue</a>";
                                        ?>
                                        </center></td>
                                    </tr>
                               <?php }} ?>
