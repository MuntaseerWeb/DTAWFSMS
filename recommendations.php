                    ...
                    <div class="content">
                        ...
                        <div class="module">
                            <div class="module-head">
                                <h3>Reccomend Something and Message To Admin</h3>
                            </div>
                            <div class="module-body">
                                    ...
                                    <form class="form-horizontal row-fluid" action="recommendations.php" method="post">
                                        <div class="control-group">
                                            <label class="control-label" for="Title"><b>Animal Title/Topic</b></label>
                                            <div class="controls">
                                        ...
                                        <div class="control-group">
                                            <div class="controls">
                                                <button type="submit" name="submit"class="btn">Submit Recommendation/Message</button>
                                            </div>
                                        </div>
                                    </form>
                            </div>
...
$sql1="insert into LMS.recommendations (Animal_Name,Description,PhoneNo) values ('$title','$Description','$phoneno')"; 
