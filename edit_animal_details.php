                    ...
                    <div class="span9">
                        <div class="module">
                            ...
                            <div class="module-body">
                                ...
                                <?php
                                    $animalid = $_GET['id'];
                                    $sql = "select * from LMS.animal where Animalid='$animalid'";
                                ...
                                ?>
                                    ...
                                    <br >
                                    <form class="form-horizontal row-fluid" action="edit_animal_details.php?id=<?php echo $bookid ?>" method="post">
                                        <div class="control-group">
                                            <b>
                                            <label class="control-label" for="Title">Animal Name:</label></b>
                                            <div class="controls">
                                        ...
                                        <div class="control-group">
                                            <b>
                                            <label class="control-label" for="Owner">Owner:</label></b>
                                            <div class="controls">
                                                <input type="text" id="Owner" name="Owner" value= "<?php echo $publisher?>" class="span8" required>
                                            </div>
                                        </div>

                                        <div class="control-group">
                                            <b>
                                            <label class="control-label" for="Year">Date:</label></b>
                                            <div class="controls">
...
$sql1="update LMS.animal set Title='$name', Owner='$owner', Year='$year', Availability='$avail' where AnimalId='$animalid'";
