                    ...
                    <div class="span9">
                        <form class="form-horizontal row-fluid" action="user.php" method="post">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="title" name="title" placeholder="Enter Name/Phone No of user" class="span8" required>
                                    ...
                                    if(isset($_POST['submit']))
                                        {$s=$_POST['title'];
                                            $sql="select * from LMS.user where (PhoneNo='$s' or Name like '%$s%') and PhoneNo<>'ADMIN'";
                                        }
                                    else
                                        $sql="select * from LMS.user where PhoneNo<>'ADMIN'";
                            ...
                            ?>
                                    <tr>
                                      ...
                                      <td><?php echo $email ?></td>                                      
                                        <td>
                                        <center>
                                            <a href="userdetails.php?id=<?php echo $phoneno; ?>" class="btn btn-success">Details</a>
                                            <!--a href="remove_student.php?id=<?php echo $phoneno; ?>" class="btn btn-danger">Remove</a-->
                                      </center>
                                        </td>
                                    </tr>
                            <?php }} ?>
