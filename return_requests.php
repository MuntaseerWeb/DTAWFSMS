                ...
                <div class="row">
                    <div class="span3">
                        <div class="sidebar">
                            ...
                            <li class="active"><a href="index.php"><i class="menu-icon icon-home"></i>Home
                                ...
                                <li><a href="book.php"><i class="menu-icon icon-book"></i>All Animals </a></li>
                                <li><a href="addbook.php"><i class="menu-icon icon-edit"></i>Add Animal </a></li>
                    ...
                    <div class="span9">
                        ...
                        <table class="table" id = "tables">
                                  ...
                                  <tbody>
                                    <?php
                            $sql="select return.AnimalId,return.PhoneNo,Title,datediff(curdate(),Due_Date) as x from LMS.return,LMS.animal,LMS.record where return.AnimalId=animal.AnimalId and return.AnimalId=record.AnimalId and return.PhoneNo=record.PhoneNo";
                            ...
                            ?>
                                    <tr>
                                      ...
                                      <td><center>
                                        ...
                                        <a href="acceptreturn.php?id1=<?php echo $animalid; ?>&id2=<?php echo $phoneno; ?>&id3=<?php echo $dues ?>" class="btn btn-success">Accept</a>
                                         
                                        <!--a href="rejectreturn.php?id1=<?php echo $animalid; ?>&id2=<?php echo $phoneno; ?>" class="btn btn-danger">Reject</a-->
                                    </center></td>
                                    </tr>
                               <?php } ?>
                               </tbody>
